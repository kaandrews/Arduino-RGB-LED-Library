...
// Set to true to report debug info over serial
const boolean DEBUG = true;   // Set to true to report debug over serial connection

/*
 * Starting state of the sketch
 * Multiple examples included.  Set to one of the following:
 * 1 - Solid blue
 * 2 - Pulsing white
 * 3 - Flashing red
 * 4 - Set to white with colour temperature 4800K
 * 6 - Cycle through colours of the rainbow
 */
byte state = 6;          // Initial state of the program

// Used by the rainbow colour loop
